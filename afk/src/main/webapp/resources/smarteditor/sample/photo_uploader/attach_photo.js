    ...
    function html5Upload() {	
    	...
    	sUploadURL= "/sample/multiplePhotoUpload"; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/sample/singlePhotoUpload",   //변경 URL입니다.
 			sCallback : "/sample/resources/smarteditor/sample/photo_uploader/callback.html",  //업로드 이후에 iframe이 redirect될 콜백페이지의 주소
